$(function() {
    ...
    function drawGraphik(flag) {
        ...
        ctx.moveTo(280, 245);
        ctx.lineTo(280, 255);
        ctx.fillText("0.5", 275, 265);
        ctx.moveTo(310, 245);
        ctx.lineTo(310, 255);
        ctx.fillText("1", 307, 265);
        ctx.moveTo(340, 245);
        ctx.lineTo(340, 255);
        ctx.fillText("1.5", 335, 265);
        ctx.moveTo(370, 245);
        ctx.lineTo(370, 255);
        ctx.fillText("2", 367, 265);
        ctx.moveTo(400, 245);
        ctx.lineTo(400, 255);
        ctx.fillText("2.5", 395, 265);
        ctx.moveTo(430, 245);
        ctx.lineTo(430, 255);
        ctx.fillText("3", 427, 265);
        ctx.moveTo(220, 245);
        ctx.lineTo(220, 255);
        ctx.fillText("-0.5", 210, 265);
        ctx.moveTo(190, 245);
        ctx.lineTo(190, 255);
        ctx.fillText("-1", 186, 265);
        ctx.moveTo(160, 245);
        ctx.lineTo(160, 255);
        ctx.fillText("-1.5", 150, 265);
        ctx.moveTo(130, 245);
        ctx.lineTo(130, 255);
        ctx.fillText("-2", 126, 265);
        ctx.moveTo(100, 245);
        ctx.lineTo(100, 255);
        ctx.fillText("-2.5", 90, 265);
        ctx.moveTo(70, 245);
        ctx.lineTo(70, 255);
        ctx.fillText("-3", 66, 265);
        ctx.moveTo(245, 220);
        ctx.lineTo(255, 220);
        ctx.fillText("0.5", 260, 223);
        ctx.moveTo(245, 190);
        ctx.lineTo(255, 190);
        ctx.fillText("1", 260, 193);
        ctx.moveTo(245, 160);
        ctx.lineTo(255, 160);
        ctx.fillText("1.5", 260, 163);
        ctx.moveTo(245, 130);
        ctx.lineTo(255, 130);
        ctx.fillText("2", 260, 133);
        ctx.moveTo(245, 100);
        ctx.lineTo(255, 100);
        ctx.fillText("2.5", 260, 103);
        ctx.moveTo(245, 70);
        ctx.lineTo(255, 70);
        ctx.fillText("3", 260, 73);
        ctx.moveTo(245, 280);
        ctx.lineTo(255, 280);
        ctx.fillText("-0.5", 260, 283);
        ctx.moveTo(245, 310);
        ctx.lineTo(255, 310);
        ctx.fillText("-1", 260, 313);
        ctx.moveTo(245, 340);
        ctx.lineTo(255, 340);
        ctx.fillText("-1.5", 260, 343);
        ctx.moveTo(245, 370);
        ctx.lineTo(255, 370);
        ctx.fillText("-2", 260, 373);
        ctx.moveTo(245, 400);
        ctx.lineTo(255, 400);
        ctx.fillText("-2.5", 260, 403);
        ctx.moveTo(245, 430);
        ctx.lineTo(255, 430);
        ctx.fillText("-3", 260, 433);

        ctx.moveTo(250, 250);
        ctx.arc(250, 250, 30 * flag, -Math.PI / 2, 0, false);
        ctx.moveTo(250 + (60 * flag), 250);
